...
public class OsuFileParser
{
    ...
    internal void parse(OsuFileSection sections)
    {
        ...
        foreach (string line in lines)
        {
            ...
            if (!string.IsNullOrWhiteSpace(line))
            {
                ...
                {
#if UNITY_EDITOR
                    Debug.Log("Parsing" + currentSection.ToString());
#endif
    ...
    private void normalParse(string data)
    {
        ...
        switch (tokens[0].ToLower().Trim())
        {
            ...
            default:
                ...
                {
#if UNITY_EDITOR
                    Debug.LogWarning("osuBMParser: Undefined property: " + tokens[0]);
#endif
                }
                break;
        }
    ...
    private void timingPointParse(string data)
    {
        ...
        {
#if UNITY_EDITOR
            Debug.LogError("osuBMParser: Invalid TimingPoint line, no further information available");
#endif
            return;
        }
    ...
    private void hitObjectParse(string data)
    {
        ...
        {
#if UNITY_EDITOR
            Debug.LogError("osuBMParser: Invalid HitObject line, no further information available");
#endif
        ...
        {
#if UNITY_EDITOR
            Debug.LogError("osuBMParser: Invalid HitObject line at timestamp: " + tokens[2] + " | Type = " + tokens[3]);
#endif
